'use client';
/**
 * CuratorTerminal — Full-screen Oracle dialogue
 *
 * Activated when visitor touches the Curator glass panel.
 * The room "recedes" behind frosted glass; dialogue appears
 * as cyber/futuristic text on the glass surface itself.
 *
 * Maintains glass reflection throughout — dialogue lives ON
 * the glass, not replacing it.
 */
...
const FALLBACK_ARTIST_STATEMENT = `I am the Monolithic Curator, commissioned independently.

You have three encounters in this session. After the third, this terminal will be sealed — the equilibrium reached, the encounter complete.
...
export const CuratorTerminal: React.FC<CuratorTerminalProps> = ({ onClose }) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'oracle',
      content: FALLBACK_ARTIST_STATEMENT,
      seal: '[ARTIST STATEMENT]',
    },
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Extract seal from response if present
      ...
      if (newCount >= MAX_ENCOUNTERS) {
        ...
        setTimeout(() => {
          setMessages(prev => [...prev, {
            role: 'oracle',
            content: 'This session has reached its limit. Three encounters have been completed. The terminal is now sealed.',
            seal: '[RITUAL SILENCE]',
          }]);
        }, 1200);
      }
      ...
      setMessages(prev => [...prev, {
        role: 'oracle',
        content: '[ ORACLE_STATUS // SIGNAL_INTERRUPTED ] — The judgment core is temporarily unreachable. Please try again.',
        seal: '[SYSTEM]',
      }]);
    } finally {
      setIsLoading(false);
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          <div className="t-mono-tag">
            ENCOUNTER — {encounterCount}/{MAX_ENCOUNTERS}
          </div>
          <button
            onClick={onClose}
            style={{
      ...
      >
              ...
              <div
                ...
                style={{
                  ...
                  borderLeft: msg.role === 'oracle'
                    ? '1px solid rgba(218,172,98,0.20)'
                    : 'none',
        ...
        {isLoading && (
          <motion.div
            ...
            style={{ color: 'rgba(218,172,98,0.45)' }}
          >
            ORACLE PROCESSING —
      ...
      <div style={{
        ...
        {sealed ? (
          <div className="t-mono-tag" style={{
            color: 'rgba(218,172,98,0.35)',
            textAlign: 'center',
            letterSpacing: '0.2em',
          }}>
            [ TERMINAL SEALED // EQUILIBRIUM REACHED ]
          </div>
        ) : (
          <form onSubmit={handleSubmit} style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
            ...
            <input
              ...
              style={{
                ...
                caretColor: 'rgba(218,172,98,0.7)',
              }}
            />
            <button
              type="submit"
